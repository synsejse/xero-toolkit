#!/usr/bin/env bash
# nv-setup — NVIDIA Driver Post-Install Configuration
# Arch-only. Run after installing NVIDIA driver packages.
# This script performs post-install configuration when an NVIDIA GPU is present:
